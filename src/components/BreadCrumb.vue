<template>
  <nav class="flex items-center justify-between max-w-screen-xl mx-auto px-4 py-4" aria-label="Breadcrumb">
      ...
      <li>
        <div class="flex items-center">
          <svg class="w-6 h-6 text-blue-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
          <a href="#" class="text-blue-700 hover:text-blue-900 ml-1 md:ml-2 text-sm font-medium">{{ Page }}</a>
        </div>
      </li>
    </ol>
  </nav>
